...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--vwe1pw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--vwe1pw.containers.anotherwebservice.com/
...
```
git clone git@github.com:SatoroSil/container--vwe1pw.git
cd container--vwe1pw
```
...
```
docker attach container--vwe1pw
```
